    ...
    const [guestEvals, setGuestEvals] = useState<[string, string, string, string, string, string][]>([]);
        ...
        return (
           <div>
                ...
                {guestEvals.length > 0 ? <div className='grid grid-cols-4 gap-2 h-min grid-flow-row overflow-y-auto max-h-[500px] mx-auto max-w-5xl bg-stone-600 border border-stone-800 p-2 pb-6 mt-6 rounded-lg '>
