...
import { Home, Courses, About, GuestEval, Grades, AcademicYear, CourseEval, ImportGrades, GradeMetrics, GuestEvalMetrics, ImportGuestEval, EditGuestEval, GuestEvalEdit, } from './pages';
...
function App() {
  ...
  return (
    <main className='text-center'>
      <nav className='flex justify-between bg-black w-full font-semibold p-2 sticky top-0 border-b-2 border-b-(--color-francis-red)'>
        <div className='px-8'>
